...
namespace WpfCore.ViewModel
{
	...
	public abstract class BaseViewModel : INotifyPropertyChanged
	{
		...
		public void SetBacking<TBacking, TProperty>(TBacking backingObject, Expression<Func<TBacking, TProperty>> propertyPath, TProperty value, [CallerMemberName] string propertyName = null)
		{
			var expr = (MemberExpression)propertyPath.Body;
